...
<div style="padding: 0;padding-right: 21px;">
    ...
    <div class="container">
        <table>
            <tr>
                <td>
                    <a href='<?php echo constant('URL') ?>agregacontroles' class="btn btn-verde">AGREGAR</div></a>
                </td>
            </tr>
        </table>
        <br>
            ...
            <div class="col-md-12" id="resBusqueda" style="height:400px; overflow: auto; border: 1px solid black; padding-left:0;">
                <table width="100%" style="margin:5px" class="tablaBusqueda table table-striped">
                    ...
                    <?php foreach($this->control as $r=> $valor): ?>
                        ...
                        <tr>
                            <td><?php echo $valor['id_control']; ?></td>
                            <td><?php echo $valor['descripcion']; ?></td>
                            <td><a href='<?php echo constant('URL') ?>edicioncontroles/edicioncontroles?id_control=<?php echo $valor['id_control']; ?>' class="btn btn-verde">EDITAR</div></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>                    
                </table>
