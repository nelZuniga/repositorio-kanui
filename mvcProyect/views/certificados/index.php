...
<script>
    ...
    function cargaMascotas(json) {
        ...
        $.each(respuesta.data.mascotas, function(key, value) {
            ...
            html += "<p class='card-text'><a title='Ver Historial' href='<?php echo constant('URL') ?>certificados/certificadosDetalle/" + value[0] + "'><img src='https://img.icons8.com/metro/26/000000/fine-print.png'></a></p>";
            html += "</div></a>";
            html += "</td>";
