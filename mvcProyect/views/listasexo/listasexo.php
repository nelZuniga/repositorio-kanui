...
<div style="padding: 0;padding-right: 21px;">
    ...
    <div class="container">
        <table>
            <tr>
                <td>
                    <a href='<?php echo constant('URL') ?>agregasexo' class="btn btn-verde">AGREGAR</div></a>
                </td>
            </tr>
        </table>
        <br>
            ...
            <div class="col-md-12" id="resBusqueda" style="height:400px; overflow: auto; border: 1px solid black; padding-left:0;">
                <table width="100%" style="margin:5px" class="tablaBusqueda table table-striped">
                    ...
                    <?php foreach($this->sexo as $r=> $valor): ?>
                        ...
                        <tr>
                            <td><?php echo $valor['id_sex']; ?></td>
                            <td><?php echo $valor['descripcion']; ?></td>
                            <td><a href='<?php echo constant('URL') ?>edicionsexo/edicionsexo?id_sex=<?php echo $valor['id_sex']; ?>' class="btn btn-verde">EDITAR</div></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>                    
                </table>
