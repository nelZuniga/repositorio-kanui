...
class loginModel extends Model{
    ...
    public function startsesion($id){
        ...
        $query = $conn->prepare("select U.id_usr, U.nombres, U.apellido_paterno, U.apellido_materno, U.documento, U.direccion, C.id_com, C.descripcion, U.correo, U.cel, U.estado from usuario U, comuna C where U.comuna = C.id_com and id_usr = ?");
        $dtype = "i";
